...
export function Footer({ className }: FooterProps) {
  return (
    <footer className={cn('bg-[#1A1A1A] text-white', className)}>
      <div className="container-beb py-16 lg:py-20">
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <Link
              href="/"
              className="font-serif text-xl font-bold tracking-[0.3em] text-white"
            >
              BEB FRAGRANCE
            </Link>
            ...
            <p className="mt-4 text-sm leading-relaxed text-[rgba(255,255,255,0.5)]">
            ...
            <div className="mt-6 flex flex-col gap-2">
              <a
                ...
                className="inline-flex items-center justify-center rounded-full border border-[rgba(255,255,255,0.2)] px-4 py-2 text-xs text-[rgba(255,255,255,0.7)] transition-colors hover:border-[rgba(255,255,255,0.4)] hover:text-white"
              >

      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center">
            {/* Avatar */}
            <div className="relative flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-full bg-gradient-to-br from-gold-400 to-gold-600 text-2xl font-bold text-white">
              {customer.image ? (
                <Image
                  src={customer.image}
                  alt={customer.name || ''}
                ...
                {customer.orders.map((order) => (
                  ...
                  >
                    ...
                    <div className="mt-2 flex gap-1">
                      {order.items.slice(0, 4).map((item) => (                          <div
                            key={item.id}
                            className="relative h-8 w-8 overflow-hidden rounded bg-gray-100"
